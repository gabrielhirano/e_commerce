        ...
        for(var id in historico){
            ...
            for(var id in pedido){
                ...
                if(!listaPedidos.includes(produto.codigo_venda)){
                    ...
                    const formaPagamento = produto.forma_pagamento;
                    const endereco = produto.endereco;
                    const dataPedido = produto.data;
                    ...
                    cardProduto.addEventListener("click", ()=>{  
                        ...
                        pedido.forEach(produto_venda =>{
                            ...
                            metodoCompra.innerHTML = formaPagamento
                            enderecoCompra.innerHTML = endereco
                            data.innerHTML = dataPedido;
